...
-- ─────────────────────────────────────────────────────────────────────────────
-- USUARIOS
-- password: "1234" (texto plano, solo para pruebas)
-- ─────────────────────────────────────────────────────────────────────────────
...
(2, 'Laura',   'Martínez Ruiz',   'laura@gohabit.com',   '1998-07-24', '611222333', 80.50,  '1234'),
...
(5, 'Miguel',  'Fernández Gil',   'miguel@gohabit.com',  '1990-06-18', '644555666', 320.75, '1234');
...
(1,  'Sombrero de vaquero',   'sombrero',  'comun'),
(2,  'Corona dorada',         'sombrero',  'legendario'),
(3,  'Gafas de sol',          'gafas',     'comun'),
(4,  'Monóculo steampunk',    'gafas',     'raro'),
(5,  'Capa de héroe',         'capa',      'raro'),
(6,  'Alas de ángel',         'capa',      'legendario'),
(7,  'Bufanda de rayas',      'bufanda',   'comun'),
(8,  'Collar de diamantes',   'collar',    'legendario'),
(9,  'Mochila aventurero',    'mochila',   'raro'),
(10, 'Bastón mágico',         'accesorio', 'legendario');

-- ─────────────────────────────────────────────────────────────────────────────
-- LOOTBOXES
-- ─────────────────────────────────────────────────────────────────────────────
INSERT INTO LootBox (id, nombre, caste, rareza) VALUES
(1, 'Caja Básica',     50,  'comun'),
(2, 'Caja Avanzada',   150, 'raro'),
(3, 'Caja Legendaria', 500, 'legendario');

-- ─────────────────────────────────────────────────────────────────────────────
-- RELACIÓN ACCESORIO ↔ LOOTBOX
-- ─────────────────────────────────────────────────────────────────────────────
INSERT INTO Accesorio_LootBox (accesorio_id, lootbox_id) VALUES
(1, 1), (3, 1), (7, 1),   -- Básica: comunes
(4, 2), (5, 2), (9, 2),   -- Avanzada: raros
(2, 3), (6, 3), (8, 3), (10, 3); -- Legendaria: legendarios
...
-- ─────────────────────────────────────────────────────────────────────────────
-- RELACIÓN AVATAR ↔ ACCESORIO (accesorios equipados/desbloqueados)
-- ─────────────────────────────────────────────────────────────────────────────
...
(5, 2), (5, 6), (5, 8), (5, 10); -- Miguel tiene todo lo legendario

-- ─────────────────────────────────────────────────────────────────────────────
-- INVENTARIO (lootboxes en posesión del usuario)
-- ─────────────────────────────────────────────────────────────────────────────
